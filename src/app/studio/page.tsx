...
export default function StudioWorkspace() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] p-6">
      <div className="max-w-4xl mx-auto bg-[#D7C9B7] rounded-[2rem] p-8 shadow-sm flex items-center gap-8 min-h-[250px]">
      ...
      <button onClick={() => setIsEditing(!isEditing)} className="mt-4 px-6 py-2 border border-[#A4927A] rounded-full font-black text-xs uppercase">
