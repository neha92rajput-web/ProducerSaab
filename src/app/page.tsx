      ...
      <main className="max-w-4xl mx-auto pt-14 pb-12 px-4 text-left space-y-6">
        ...
        <div className="pt-4">
          <div className="rounded-2xl overflow-hidden border border-[#EAE6DA] shadow-sm bg-neutral-100 aspect-[16/10]">
            <img src="https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=1200&auto=format&fit=crop&q=80" className="w-full h-full object-cover" alt="Tropical Studio Vibe" />
          </div>
        </div>
