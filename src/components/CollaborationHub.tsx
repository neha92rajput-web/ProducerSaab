...
export default function CollaborationHub({ profileId }: CollabHubProps) {
  ...
  return (
    <div className="space-y-8 text-black w-full text-left">
      ...
      <div className="space-y-3">
        ...
        <div className="grid gap-3">
          {incomingRequests.length > 0 ? (
            ...
            <div className="text-center p-8 border border-dashed border-[#E3DEC1] rounded-2xl text-xs text-gray-400 font-medium bg-white/30 w-full">
              No incoming session request letters waiting in your inbox yet.
            </div>
          )}
        </div>
      </div>
      ...
      <div className="space-y-3 pt-4">
        ...
        <div className="grid gap-3">
          {sentRequests.length > 0 ? (
            ...
            <div className="text-center p-6 border border-dashed border-[#E3DEC1] rounded-2xl text-xs text-gray-400 font-medium w-full">
              You haven't dispatched any outgoing collaboration notes yet.
            </div>
          )}
        </div>
      </div>
